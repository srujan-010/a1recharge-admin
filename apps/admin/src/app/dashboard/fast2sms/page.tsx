...
export default function Fast2SMSDashboardPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-indigo-900/10 via-purple-900/10 to-pink-900/10 dark:from-indigo-950/40 dark:via-purple-950/30 dark:to-pink-950/20 p-5 sm:p-6 rounded-[24px] border border-indigo-200/60 dark:border-indigo-800/40">
        <div className="flex items-center gap-3.5 sm:gap-4 min-w-0">
          <div className="w-12 h-12 rounded-2xl bg-indigo-600 text-white flex items-center justify-center shadow-lg shadow-indigo-600/20 shrink-0 self-center">
          ...
          <div className="flex flex-col justify-center min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge className="bg-emerald-500 text-white font-bold text-[10px] gap-1 px-2 py-0.5 shrink-0">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto shrink-0 pt-2 md:pt-0 border-t md:border-t-0 border-indigo-200/40 dark:border-indigo-800/20">
          <Button
            variant="outline"
          ...
          <Button
            ...
            disabled={isSyncing}
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-11 px-5 rounded-xl shadow-lg shadow-indigo-600/20 text-xs gap-2 flex-1 md:flex-initial"
          >
